...
os.environ['ENV_DEFAULT_LLM_PROVIDER'] = 'SELECTED_LLM_PROVIDER'
os.environ['ENV_DEFAULT_GEMINI_MODEL_NAME'] = 'GEMINI_MODEL'
os.environ['ENV_DEFAULT_OPENAI_MODEL_NAME'] = 'OPENAI_MODEL'
os.environ['ENV_DEFAULT_ANTHROPIC_MODEL_NAME'] = 'ANTHROPIC_MODEL'
os.environ['ENV_DEFAULT_GEMINI_TEMPERATURE'] = 'GEMINI_TEMPERATURE'
os.environ['ENV_DEFAULT_OPENAI_TEMPERATURE'] = 'OPENAI_TEMPERATURE'
os.environ['ENV_DEFAULT_ANTHROPIC_TEMPERATURE'] = 'ANTHROPIC_TEMPERATURE'
